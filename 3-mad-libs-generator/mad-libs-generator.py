...
class Mad_Libs():
    ...
    #---Adding Parts of speech------------
        ...
        #Noun(Plural) label
        self.noun_label = Label(main,text="Noun(Plural)",font = Font(weight="bold",size=8,family="Tekton Pro"))
        ...
        #Noun label
        self.noun_label = Label(main,text="Adjective",font = Font(weight="bold",size=10,family="Tekton Pro"))
